...
function elsagr_activation()
  ...
  add_option( 'elsa-opt-version', elsagr_getVersion(), '', 'yes' );
...
function elsagr_getVersion()
  {
  $f=file(__wDir__.'elsa-grabber.php');
    foreach ($f as $l)
      {
      if (strpos($l,'Version: ')===false){continue;}
      $v=str_replace('Version: ','',$l);
      break;
      }
  return trim($v);
  }
